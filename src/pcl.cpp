 ...
 * @return .
 */
int CMesh2Pcl::GetTensorSizeWords(){
 ...
 * @return .
 */
int CMesh2Pcl::GetTensorSizeBytes(){
 ...
 * @return vector<int>
 */
vector<int> CMesh2Pcl::GetTensorShape(){
    vector<int> shape;
 ...
 */
void CMesh2Pcl::CloneToBuffRowMajor(float *outBuff){
 ...
 * @return .
 */
inline double CMesh2Pcl::UniformDeviate(int seed){
 ...
 * @return .
 */
inline void CMesh2Pcl::RandomPointTriangle(
        float a1, 
        float a2, 
        float a3, 
        float b1, 
 ...
 * @return .
 */
inline void CMesh2Pcl::RandPSurface(
 ...
 * @return .
 */
void CMesh2Pcl::UniformSampling(
